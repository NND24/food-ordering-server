...
const swaggerDefinition = {
  openapi: "3.0.0",
  info: {
    title: "Topping Service API",
    version: "1.0.0",
    description: "Topping service for the food ordering system",
  },
  servers: [
    {
      url: `http://localhost:${process.env.PORT || 5013}`,
      description: "Topping Service API",
    },
  ],
};
