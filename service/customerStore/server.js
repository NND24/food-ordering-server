...
const swaggerDefinition = {
  openapi: "3.0.0",
  info: {
    title: "Customer Store Service API",
    version: "1.0.0",
    description: "Customer Store service for the customer store system",
  },
  servers: [
    {
      url: `http://localhost:${process.env.PORT || 5019}`,
      description: "Customer Store Service API",
    },
  ],
};
